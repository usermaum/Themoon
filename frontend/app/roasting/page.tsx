...
export default function RoastingMainPage() {
    return (
        <div className="min-h-screen bg-[#FDFBF7]">
            ...
            <div className="container mx-auto p-6 max-w-4xl -mt-16 relative z-20">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* 싱글 오리진 로스팅 카드 */}
                    <Link href="/roasting/single-origin" className="group relative flex flex-col items-center bg-white rounded-[2rem] shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        {/* 상단 이미지 */}
                        <div
                    ...
                    {/* 블렌드 로스팅 카드 */}
                    <Link href="/roasting/blend" className="group relative flex flex-col items-center bg-white rounded-[2rem] shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                        {/* 상단 이미지 */}
                        <div
                            className="w-full h-48 bg-cover bg-center transition-transform duration-700 group-hover:scale-105"
