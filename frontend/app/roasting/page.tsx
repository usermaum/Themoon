...
import { Flame, Layers, ArrowRight, Coffee, History, Package, Plus, TrendingUp } from 'lucide-react';
import Link from 'next/link';
import { useLoading } from '@/components/providers/loading-provider';
import { RoastingDashboard } from "@/components/roasting/RoastingDashboard";
import RoastingHistory from '@/components/roasting/RoastingHistory';
...
export default function RoastingMainPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col">
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    backgroundImage: "url('/images/raw_material/01_yirgacheffe_raw_web.webp')",
                  }}
                >
                ...
                <div className="relative -mt-10 bg-white rounded-[1.5rem] shadow-lg px-6 py-5 w-[85%] text-center border border-latte-50 z-10 group-hover:border-latte-200 transition-colors">
                  <h2 className="font-serif text-2xl font-bold text-latte-900 mb-1">
                    Single Origin
                  </h2>
                  <p className="text-[10px] font-bold tracking-[0.2em] text-latte-400 uppercase">
                    Roasting Process
                  </p>
                </div>
      ...
      {/* 히스토리 영역 */}
      <div className="bg-latte-50/30 py-16 border-t border-latte-100">
        <div className="container mx-auto px-6 max-w-4xl">
          <RoastingHistory />
        </div>
      </div>
