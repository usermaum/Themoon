        ...
        <div className="min-h-screen">
            ...
            <div className="container mx-auto px-4 py-8 max-w-3xl">
                <div className="flex justify-between items-center mb-6">
                    <Button variant="ghost" onClick={() => router.back()} className="pl-0 hover:bg-transparent hover:text-latte-800">
                        <ArrowLeft className="w-4 h-4 mr-2" /> 목록으로 돌아가기
                    </Button>
                    <Button variant="destructive" onClick={handleDelete} className="bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 border-none">
