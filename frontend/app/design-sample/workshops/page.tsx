      ...
      <div className="max-w-6xl mx-auto pt-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <Card className="bg-latte-900 text-latte-100 border-none relative overflow-hidden">
            ...
            <CardHeader>
              ...
              <CardDescription className="text-latte-300">
                Level up your pouring skills.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex -space-x-3 mb-4">
                <Avatar className="border-2 border-latte-900">
                ...
                <div className="w-10 h-10 rounded-full bg-latte-800 flex items-center justify-center text-xs border-2 border-latte-900">
                  +12
                </div>
              </div>
              <Button
                variant="outline"
                className="w-full border-latte-700 text-white hover:bg-latte-800 hover:text-white"
              >
                View Curriculum
              </Button>
            </CardContent>
        ...
        <div className="lg:col-span-8 space-y-6">
          <h2 className="font-serif text-2xl text-latte-800 mb-6 flex items-center gap-2">
            Available Sessions{' '}
            <Badge variant="secondary" className="bg-latte-200 text-latte-800">
              3 Spots Left
            </Badge>
          </h2>
          ...
          <Card className="bg-white border-latte-100 hover:border-latte-300 transition-colors group cursor-pointer">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-6 flex flex-col justify-between">
                <div>
                  <h3 className="font-serif text-xl font-bold text-latte-900 group-hover:text-latte-700 transition-colors">
                    Latte Art Basics
                  </h3>
          ...
          <Card className="bg-white border-latte-100 hover:border-latte-300 transition-colors group cursor-pointer opacity-70">
            <div className="flex flex-col md:flex-row">
              <div className="w-full md:w-48 bg-latte-50 relative min-h-[160px]">
                <div className="flex items-center justify-center h-full text-latte-400 font-serif italic">
                  Sold Out
                </div>
              </div>
              <div className="flex-1 p-6 flex flex-col justify-between">
                ...
                <Button disabled variant="secondary" className="mt-4 w-fit">
                  Join Waitlist
                </Button>
              </div>
            </div>
