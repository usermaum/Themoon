    ...
    <div className="min-h-screen bg-[#FFF8F0] p-8 font-sans relative">
      ...
      <div className="max-w-5xl mx-auto pt-16 pb-20">
        <div className="text-center mb-16">
          <span className="text-xs font-bold text-latte-500 uppercase tracking-[0.3em] mb-2 block">
            Premium Selection
          </span>
  ...
  return (
    <Card className="bg-white border-none shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group">
      <div className="h-48 relative overflow-hidden bg-latte-100">
        <img
          src={image}
          className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 mix-blend-multiply opacity-80"
        />
      ...
      <div className="p-6">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                size="icon"
                variant="ghost"
                className="h-6 w-6 text-latte-400 hover:text-latte-600"
              >
                <Info size={16} />
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-64 bg-latte-900 text-latte-50 border-none shadow-xl">
              <div className="space-y-2">
                <h4 className="font-bold text-sm border-b border-latte-700 pb-1 mb-2">
                  Nutritional Info
                </h4>
        ...
        <p className="text-sm text-latte-500 leading-relaxed mb-6 h-12 line-clamp-2">{desc}</p>
        ...
        <Button className="w-full bg-latte-100 text-latte-900 hover:bg-latte-200 border border-latte-200 shadow-none font-bold group/btn">
          <Plus size={16} className="mr-2 group-hover/btn:rotate-90 transition-transform" /> Add to
          Order
        </Button>
      </div>
    </Card>
