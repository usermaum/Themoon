      ...
      <Card className="w-full max-w-2xl bg-white border border-latte-200 shadow-2xl relative z-10">
        <CardHeader className="bg-latte-50/50 border-b border-latte-100 pt-10 pb-6 text-center space-y-2">
          ...
          <CardDescription className="text-latte-500">
            Record the sensory details of today's roast.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label
                htmlFor="bean-name"
                className="text-xs font-bold uppercase tracking-wider text-latte-400"
              >
                Bean Name
              </Label>
              <Input
                id="bean-name"
                placeholder="e.g. Kenya AA Top"
                className="border-latte-200 focus-visible:ring-latte-400 bg-latte-50/30 font-medium text-latte-800"
              />
            </div>
            <div className="space-y-2">
              <Label
              ...
              <Input
                id="roast-date"
                type="date"
                className="border-latte-200 focus-visible:ring-latte-400 bg-latte-50/30 text-latte-600"
              />
            </div>
          </div>
