            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto pt-12">
                ...
                <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm overflow-hidden group">
                    ...
                    <CardHeader className="relative z-20 -mt-8 mx-4 bg-white rounded-xl shadow-sm text-center pb-2">
                        ...
                        <CardDescription className="text-latte-600 font-medium tracking-wide text-xs uppercase mt-1">Light Roast • Floral</CardDescription>
                    </CardHeader>
                ...
                <Card className="bg-latte-900 text-latte-50 border-latte-800 relative overflow-hidden">
                    ...
                    <CardHeader>
                        ...
                        <CardTitle className="font-serif text-3xl text-latte-50 tracking-tight">Espresso<br />Romano</CardTitle>
                    </CardHeader>
                    <CardContent className="relative z-10 space-y-4">
                        <div className="flex items-center gap-4 text-sm text-latte-200">
                            <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-latte-400"></div> Intense</span>
                            <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-latte-400"></div> Citrusy</span>
                        </div>
                    ...
                    <CardFooter className="flex justify-between items-center border-t border-latte-800 pt-6 mt-4">
                        ...
                        <Button variant="outline" className="border-latte-600 text-latte-200 hover:bg-latte-800 hover:text-white">Order</Button>
                    </CardFooter>
                </Card>
                ...
                <Card className="bg-[#fcf8f5] border-2 border-dashed border-latte-300 shadow-none relative">
                    ...
                    <CardHeader className="text-center pt-8">
                        <CardTitle className="font-serif italic text-3xl text-latte-800 decoration-latte-300 decoration-2 underline underline-offset-4">Today's Pick</CardTitle>
                    </CardHeader>
