...
import { Sparkles, ArrowRight, Check, Coffee, RefreshCw, Zap, Bell, Heart } from 'lucide-react'
            ...
            <div className="max-w-5xl mx-auto space-y-12">
                ...
                >
                    ...
                    <p className="text-lg text-latte-600 max-w-2xl mx-auto">
                        ...
                        <br /><span className="text-sm opacity-70">Powered by Framer Motion</span>
                    </p>
                </motion.header>
            ...
            <Card className="h-full border-latte-200 shadow-md hover:shadow-xl transition-shadow duration-300">
                ...
                <CardContent>
                    <p className="text-latte-600">
                        A subtle lift effect that adds a premium feel to your UI components.
                        Best used for clickable cards or important content blocks.
                    </p>
                </CardContent>
            </Card>
        </motion.div>
    ...
    return (
        <div className="relative group h-full">
            ...
            <Card className="relative h-full bg-white border-none">
                ...
                <CardContent>
                    <p className="text-latte-600">
                        A beautiful gradient glow effect using absolute positioning and blur.
                        Great for highlighting premium features or active states.
                    </p>
                </CardContent>
            </Card>
        </div>
