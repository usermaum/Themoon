...
export default function BadgeSamplePage() {
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
                ...
                <Card className="bg-white border-latte-100 shadow-sm">
                    <CardContent className="p-8 space-y-6">
                        <h3 className="font-serif text-xl text-latte-800 border-b border-latte-100 pb-2 mb-4">Roast Levels</h3>
                ...
                <Card className="bg-latte-50 border-none shadow-inner">
                    <CardContent className="p-8 space-y-6">
                        <h3 className="font-serif text-xl text-latte-800 border-b border-latte-200/50 pb-2 mb-4">Flavor Notes</h3>

                        <div className="flex flex-wrap gap-2">
                            <Badge variant="outline" className="border-latte-400 text-latte-700 bg-white hover:bg-latte-100 rounded-lg px-3">
                                Chocolate
                            </Badge>
                            <Badge variant="outline" className="border-latte-400 text-latte-700 bg-white hover:bg-latte-100 rounded-lg px-3">
                                Nutty
                            </Badge>
                            <Badge variant="outline" className="border-pink-300 text-pink-700 bg-white hover:bg-pink-50 rounded-lg px-3">
                                Berry
                            </Badge>
                            <Badge variant="outline" className="border-orange-300 text-orange-700 bg-white hover:bg-orange-50 rounded-lg px-3">
                                Citrus
                            </Badge>
                        </div>
                    </CardContent>
