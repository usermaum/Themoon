        ...
        <div className="min-h-screen bg-latte-50 p-12 font-sans flex flex-col items-center justify-center gap-16 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 w-full max-w-5xl">
                ...
                <div className="space-y-6 flex flex-col items-center p-8 bg-latte-100/50 rounded-[2rem] border border-latte-200">
                    ...
                    <Button variant="outline" className="w-full border-2 border-latte-800 text-latte-900 hover:bg-latte-800 hover:text-white rounded-full h-12 font-bold tracking-wide">
                        VIEW MENU
                    </Button>

                    <Button variant="outline" className="w-full border-latte-300 text-latte-700 hover:bg-white hover:border-latte-400 bg-white/50 rounded-xl dashed border-2">
                        Customize Order
                    </Button>

                    <Button variant="secondary" className="w-full bg-white text-latte-800 hover:bg-latte-50 shadow-sm border border-latte-100">
                ...
                <div className="space-y-6 flex flex-col items-center p-8">
                    ...
                    <div className="flex gap-4">
                        <Button size="icon" className="rounded-full w-14 h-14 bg-latte-800 hover:bg-latte-700 shadow-xl shadow-latte-400/50 text-latte-100">
                            <Plus className="h-6 w-6" />
                        </Button>
                        <Button size="icon" variant="outline" className="rounded-full w-14 h-14 border-2 border-latte-300 text-latte-600 hover:border-latte-500 hover:bg-latte-50">
                            <Coffee className="h-6 w-6" />
                        </Button>
                    </div>

                    <Button variant="ghost" className="text-latte-600 hover:text-latte-900 hover:bg-latte-100/50 -ml-2">
                        Skip for now
                    </Button>
