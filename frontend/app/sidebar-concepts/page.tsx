...
const SidebarThree = () => (
    <div className="h-full w-64 bg-gradient-to-b from-sky-50 to-white border-r border-sky-100 flex flex-col">
        ...
        <div className="flex-1 px-3 py-4 space-y-1">
            <div className="text-xs font-bold text-sky-400/80 px-4 mb-2 uppercase tracking-wider">Menu</div>
            {menuItems.map((item) => (
                <button
                    key={item.label}
                    className={cn(
                ...
                >
                    <div className="flex items-center gap-3">
                        <item.icon size={18} className={cn("transition-colors", item.active ? "text-sky-500" : "text-slate-400 group-hover:text-sky-400")} />
                        {item.label}
                    </div>
        ...
        <div className="min-h-screen bg-white font-sans">
            ...
            <div className="border-b sticky top-0 bg-white/80 backdrop-blur-md z-10 px-8 py-4 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 text-sm">Next.js & Shadcn Compatible • Simple & Refreshing</p>
                </div>
                ...
                <div className="rounded-xl border border-stone-200 bg-white h-[600px] overflow-hidden flex shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 bg-stone-50 p-8 flex flex-col">
                        <div className="mb-8">
                            ...
                            <p className="text-lime-600 text-sm font-medium">Dark Sidebar • Pop Color • Icon-only</p>
                        </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-[#F2F4F8] h-[600px] overflow-hidden flex shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 p-8 flex flex-col">
                        <div className="mb-8 flex justify-between items-center">
                            ...
                            <Button className="bg-indigo-500 hover:bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200 text-white border-0">Action</Button>
                        </div>
            ...
            <div className="text-center py-12 bg-slate-50 border-t">
                ...
                <p className="text-slate-600 mb-8">
                    선택하신 사이드바 디자인을 현재 프로젝트의 <code>Sidebar.tsx</code>에 바로 적용해드릴 수 있습니다.
                </p>
            </div>
        </div>
    )
