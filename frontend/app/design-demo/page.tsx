...
export default function DesignDemoPage() {
    const [selectedTab, setSelectedTab] = useState<'components' | 'scenarios' | 'extended' | 'showcase'>('showcase')
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="bg-white rounded-3xl shadow-lg border border-latte-200 p-2 inline-flex flex-wrap gap-2">
                        {[
                            ...
                            <Button
                                ...
                                className={`text-base px-6 py-6 rounded-2xl transition-all ${selectedTab === tab.id
                    ...
                    >
                        <motion.section variants={itemVariants}>
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-serif font-bold text-latte-900 mb-4">Base UI Components</h2>
                                <p className="text-latte-600">Fundamental building blocks for the application interface.</p>
                            </div>
                ...
                {selectedTab === 'scenarios' && (
                    ...
                    >
                        <motion.section variants={itemVariants}>
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-serif font-bold text-latte-900 mb-4">Real-world Scenarios</h2>
                ...
                {selectedTab === 'extended' && (
                    ...
                    >
                        <motion.section variants={itemVariants}>
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-serif font-bold text-latte-900 mb-4">Extended Features</h2>
                                <p className="text-latte-600">Advanced/Complex layouts and experimental features.</p>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {extended.map((sample) => (
                                    <SampleCard key={sample.title} sample={sample} />
