            ...
            <div className="max-w-6xl mx-auto pt-8 space-y-6">
                ...
                <Card className="bg-white border-latte-100 shadow-sm overflow-hidden rounded-xl">
                    <CardContent className="p-0">
                        <Table>
                            <TableCaption className="pb-4 text-latte-400">
                            ...
                            <TableBody>
                                {orders.map((order) => (
                                    <TableRow key={order.id} className="border-latte-50 hover:bg-latte-50/30">
                                        ...
                                        <TableCell
                                            className="text-latte-700 max-w-[200px] truncate"
                                            title={order.items}
                                        >
                                            {order.items}
                                        </TableCell>
                                        ...
                                        <TableCell>
                                            <Badge
                                                variant="outline"
                                                className={`border-0 font-medium ${order.status === 'Processing'
                                        ...
                                        <TableCell className="text-right font-mono text-latte-800">
                                            {order.total}
                                        </TableCell>
                                        <TableCell>
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="h-8 w-8 text-latte-400 hover:text-latte-900"
                                            >
