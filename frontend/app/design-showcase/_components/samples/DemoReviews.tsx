            ...
            <div className="max-w-7xl mx-auto pt-12">
                <div className="text-center mb-16 px-4">
                    ...
                    <div className="mt-8 flex justify-center gap-2">
                        ...
                        <span className="self-center text-sm text-latte-500 font-bold uppercase tracking-wider">
    ...
    return (
        <Card className="bg-white border-none shadow-md hover:shadow-xl transition-shadow break-inside-avoid mb-8 relative">
            ...
            <CardContent className="p-8">
                ...
                <p className="text-latte-700 leading-relaxed mb-6 font-serif text-lg">"{text}"</p>
                <div className="flex items-center gap-3">
                    <Avatar className="h-10 w-10 border border-latte-100">
                        <AvatarImage src={image} />
                        <AvatarFallback className="bg-latte-100 text-latte-600">
                            {name.charAt(0)}
                        </AvatarFallback>
                    </Avatar>
                    <div>
