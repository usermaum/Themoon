                        ...
                        <Card className="bg-white border-latte-100">
                            ...
                            <CardContent className="space-y-4">
                                <p className="text-latte-700 text-sm leading-relaxed">
                                    Choose your roast preference and frequency. We curate the best beans from around
        ...
        <Card className="border border-latte-100 bg-white hover:border-latte-300 transition-colors shadow-sm hover:shadow-md cursor-pointer group">
            <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                    <CardTitle className="text-lg font-serif text-latte-900 group-hover:text-latte-600 transition-colors">
                        {title}
                    </CardTitle>
            ...
            <CardFooter className="pt-0">
                <div className="flex gap-2">
                    {tags.map((tag) => (
                        <span
                            key={tag}
                            className="text-[10px] bg-latte-50 text-latte-600 px-2 py-1 rounded-full uppercase tracking-wide font-medium"
                        >
                            {tag}
                        </span>
                    ))}
