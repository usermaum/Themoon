        ...
        <div className="min-h-screen bg-white font-sans relative flex flex-col">
            ...
            <main className="flex-1 max-w-3xl mx-auto w-full p-8 md:p-12">
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-latte-500">
                            We'll curate the perfect roast based on your equipment.
                        </p>
                    </div>
                    ...
                    <RadioGroup defaultValue="drip" className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Label
                            htmlFor="drip"
                            className="cursor-pointer [&:has([data-state=checked])]:border-latte-800 [&:has([data-state=checked])]:bg-latte-50"
                        >
                            <Card className="border-2 border-latte-100 shadow-sm hover:border-latte-300 transition-all p-6 flex items-start gap-4 h-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-latte-500">
                                        Paper filters, Chemex, V60. We'll send medium-light roasts.
                                    </p>
                                </div>
                            </Card>
                        </Label>
                        ...
                        >
                            <Card className="border-2 border-latte-100 shadow-sm hover:border-latte-300 transition-all p-6 flex items-start gap-4 h-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-latte-500">
                                        High pressure extraction. We'll send developed medium-dark roasts.
                                    </p>
                                </div>
                            </Card>
                        </Label>
                        ...
                        >
                            <Card className="border-2 border-latte-100 shadow-sm hover:border-latte-300 transition-all p-6 flex items-start gap-4 h-full">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-latte-500">
                                        Immersion brewing. Perfect for rich, full-bodied beans.
                                    </p>
                                </div>
                            </Card>
                        </Label>
                        ...
                        <Label
                            htmlFor="pods"
                            className="cursor-pointer [&:has([data-state=checked])]:border-latte-800 [&:has([data-state=checked])]:bg-latte-50 opacity-60"
                        >
                ...
                <div className="mt-12 flex justify-between items-center">
                    <Button variant="ghost" className="text-latte-400">
                        Skip Customization
                    </Button>
