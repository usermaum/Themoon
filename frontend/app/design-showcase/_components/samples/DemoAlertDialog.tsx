            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-5xl">
                    ...
                    <CardContent className="space-y-6 pt-6">
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent className="bg-white border-latte-200 rounded-[2rem] shadow-2xl">
                                <AlertDialogHeader>
                                    <AlertDialogTitle className="font-serif text-2xl text-latte-900">
                                        Are you absolutely sure?
                                    </AlertDialogTitle>
                                    <AlertDialogDescription className="text-latte-600">
                                        This action cannot be undone. This will permanently delete your blending recipe
                                        from our servers.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter className="gap-2 sm:gap-0">
                                    <AlertDialogCancel className="rounded-xl border-latte-200 text-latte-700 hover:bg-latte-50 mt-0">
                                        Cancel
                                    </AlertDialogCancel>
                                    <AlertDialogAction className="bg-red-600 hover:bg-red-700 rounded-xl text-white">
                                        Delete Recipe
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                ...
                <Card className="bg-white border-latte-100 flex flex-col items-center justify-center text-center p-6 shadow-sm">
                    <CardContent className="space-y-6 pt-6">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button className="w-full bg-latte-800 text-latte-50 hover:bg-latte-900">
                                    Proceed to Payment
                                </Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent className="bg-[#FFF8F0] border-latte-200 rounded-[2rem] shadow-2xl">
                                <AlertDialogHeader className="items-center text-center">
                                    ...
                                    <AlertDialogDescription className="text-latte-700">
                                        You are about to purchase <strong>3 items</strong> from your cart. Proceed with
                                        the detailed transaction?
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter className="sm:justify-center gap-4 mt-4">
                                    <AlertDialogCancel className="rounded-full border-none bg-transparent hover:bg-latte-200/50 text-latte-600 w-auto px-6">
                                        Modify Cart
                                    </AlertDialogCancel>
                                    <AlertDialogAction className="rounded-full bg-latte-900 hover:bg-black w-auto px-8">
                                        Confirm Payment
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                ...
                <Card className="bg-white border-latte-100 flex flex-col items-center justify-center text-center p-6 shadow-sm">
                    <CardContent className="space-y-6 pt-6">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild>
                                <Button variant="outline" className="w-full border-latte-200 text-latte-600">
                                    Log Out
                                </Button>
                            </AlertDialogTrigger>
                            <AlertDialogContent className="bg-white border-latte-100 rounded-[1rem] shadow-xl max-w-sm">
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction className="h-9 text-xs bg-gray-900 text-white">
                                        Sign Out
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
