...
const VaultLogo = () => (
    <svg viewBox="0 0 200 200" className="w-full h-full drop-shadow-md">
        ...
        {/* Text Path Area */}
        <path
            d="M100 20 C 150 20, 180 60, 180 100 C 180 140, 150 180, 100 180 C 50 180, 20 140, 20 100 C 20 60, 50 20, 100 20"
            fill="none"
            id="textCurve"
        />
        ...
        <g transform="translate(100 105) scale(0.8)">
            <path
                d="M0 -30 Q 30 -30 30 0 Q 30 30 0 50 Q -30 30 -30 0 Q -30 -30 0 -30 Z"
                fill="#66BB6A"
                stroke="#1B5E20"
                strokeWidth="2"
            />
...
export function DemoGreenBeanVault() {
    return (
        <div className="flex h-screen w-full font-serif overflow-hidden relative bg-[#2C1E1A]">
            {/* Sidebar (Left) */}
            <aside
                className="hidden md:flex w-72 h-full flex-col z-20 shadow-[4px_0_15px_rgba(0,0,0,0.5)] relative"
                style={burlapStyle}
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        maskImage:
                            "url(\"data:image/svg+xml,%3Csvg width='10' height='20' viewBox='0 0 10 20' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0 L10 10 L0 20 Z' fill='black'/%3E%3C/svg%3E\")",
                        maskSize: '10px 8px',
                    }}
                ></div>
                ...
                <div className="p-6 border-t border-[#5D4037]/20">
                    <Button
                        variant="ghost"
                        className="w-full justify-start text-[#5D4037] hover:bg-[#5D4037]/10 uppercase tracking-[0.2em] font-bold text-[10px] h-10"
                    >
            ...
            <main className="flex-1 flex flex-col relative h-full">
                ...
                <div className="absolute top-6 right-6 z-50">
                    <Button
                        asChild
                        variant="outline"
                        className="bg-black/20 backdrop-blur-sm border-white/20 text-white hover:bg-white/30 rounded-full px-6"
                    >
                ...
                <div className="h-[45%] relative w-full bg-[#1a120e] overflow-hidden group">
                    ...
                    <div className="absolute top-1/4 left-[15%] animate-pulse-slow hidden lg:block">
                        ...
                        >
                            <path
                                d="M30,20 L60,10 L70,40 L50,70 L20,60 Z"
                                fill="#EBE5D9"
                                stroke="#D4AF37"
                                strokeWidth="2"
                                opacity="0.9"
                            />
                            <text x="45" y="45" fontSize="8" fill="#3E2723" fontWeight="bold" fontFamily="serif">
                                ETHIOPIA
                            </text>
                        </svg>
                    </div>
                    <div className="absolute bottom-[20%] right-[15%] animate-bounce-slow hidden lg:block">
                        ...
                        >
                            <path
                                d="M40,20 L80,30 L70,70 L30,60 Z"
                                fill="#EBE5D9"
                                stroke="#D4AF37"
                                strokeWidth="2"
                                opacity="0.9"
                            />
                            <text x="55" y="50" fontSize="8" fill="#3E2723" fontWeight="bold" fontFamily="serif">
                                KENYA
                            </text>
                        </svg>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto h-full flex flex-col p-8 md:p-12">
                        ...
                        <div className="mt-auto pt-8 border-t border-[#5D4037]/10 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-[0.15em] text-[#5D4037] font-bold gap-4">
                            <div className="space-x-8">
                                <span className="cursor-pointer hover:text-[#3E2723] transition-colors">
                                    About Us
                                </span>
                                <span className="cursor-pointer hover:text-[#3E2723] transition-colors">
                                    Sustainability
...
function NavItem({ icon, label, active = false }: { icon: any; label: string; active?: boolean }) {
    return (
        ...
        >
            ...
            <span
                className={`text-xs font-bold tracking-[0.2em] ${active ? 'text-[#3E2723]' : 'text-[#5D4037] group-hover:text-[#3E2723]'}`}
            >
                {label}
            </span>
            {active && (
                <Leaf className="ml-auto w-4 h-4 text-[#556B2F] animate-in fade-in slide-in-from-right-2" />
            )}
        </div>
    );
}
    ...
    return (
        <Card className="border border-[#BCAAA4] bg-[#EBE5D9] shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 p-2 flex flex-col md:flex-row gap-0 overflow-hidden group h-full md:h-60 rounded-xl">
            ...
            <div className="flex-1 p-6 flex flex-col justify-between relative">
                ...
                <div>
                    <h3 className="font-serif text-2xl font-bold text-[#3E2723] uppercase tracking-wide mb-1 leading-none drop-shadow-sm">
                        {bean.name}
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-[10px] text-[#5D4037] uppercase tracking-wide font-medium mb-4">
                        ...
                        <div className="col-span-2 flex flex-col mt-1 bg-[#fff] p-2 rounded border border-[#e0e0e0] shadow-sm">
                            ...
                            <span className="normal-case italic font-serif text-xs text-[#3E2723]">
                                {bean.notes}
                            </span>
                        </div>
                    </div>
                ...
                <div className="space-y-3 relative z-10">
                    <div className="flex justify-between items-end text-[9px] font-bold uppercase tracking-wider text-[#5D4037]">
                        ...
                        <span className={bean.stock > 40 ? 'text-[#556B2F]' : 'text-[#E65100]'}>
                            {bean.stock > 40 ? 'High' : 'Low'}
                        </span>
                    </div>
