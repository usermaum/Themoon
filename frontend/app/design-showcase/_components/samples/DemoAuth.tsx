...
export function DemoAuth() {
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 font-sans bg-white relative">
            {/* Back Nav - overlaying on mobile, or positioned in top left */}
            ...
            <div className="flex items-center justify-center p-8 lg:p-24 bg-latte-50">
                <Card className="w-full max-w-md border-none shadow-xl bg-white/80 backdrop-blur-sm">
                    <CardContent className="p-8 space-y-8">
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="email"
                                    type="email"
                                    placeholder="barista@themoon.com"
                                    className="bg-white border-latte-200"
                                />
                            </div>
                            <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    <Label htmlFor="password">Password</Label>
                                    <span className="text-xs text-latte-600 hover:underline cursor-pointer">
                                        Forgot password?
                                    </span>
                                </div>
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    id="remember"
                                    className="border-latte-300 text-latte-900 data-[state=checked]:bg-latte-900 data-[state=checked]:border-latte-900"
                                />
                                <label
                                    htmlFor="remember"
                        ...
                        <Button className="w-full bg-latte-900 hover:bg-latte-800 text-white h-11 text-base">
                            Sign In
                        </Button>
                        ...
                        <div className="flex gap-4 justify-center">
                            <Button
                                variant="outline"
                                size="icon"
                                className="rounded-full border-latte-200 text-latte-600 hover:bg-latte-50"
                            >
                                <Instagram size={18} />
                            </Button>
                            <Button
                        ...
                        <p className="text-center text-sm text-latte-500">
                            ...
                            <span className="text-latte-900 font-bold hover:underline cursor-pointer">
                                Sign up
                            </span>
                        </p>
                    </CardContent>
