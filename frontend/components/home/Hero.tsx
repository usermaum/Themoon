        ...
        <div className="flex-1 text-center md:text-left max-w-3xl">
          ...
          >
            <Button asChild size="lg" className="text-lg">
              <Link href="/beans">원두 관리 시작하기</Link>
            </Button>
            <Button
              asChild
              variant="outline"
              size="lg"
              className="text-lg bg-white/10 border-white/30 text-white hover:bg-white/20 hover:text-white backdrop-blur-md"
            >
              <Link href="/blends">블렌드 레시피 보기</Link>
            </Button>
          </motion.div>
        </div>
      </div>
