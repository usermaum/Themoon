  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <form
        ...
        className="space-y-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700"
      >
        {/* 기본 정보 섹션 */}
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center border-b pb-2">
            ...
            <span
              className={`font-bold ${Math.abs(calculateTotalRatio() - 100) < 0.1 ? 'text-green-600' : 'text-red-500'}`}
            >
