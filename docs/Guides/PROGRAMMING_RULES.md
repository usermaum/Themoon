...
3️⃣ 문서 4종 세트 업데이트 ← 이것 없으면 작업 미완료!
   ...
   - [ ] docs/Progress/SESSION_SUMMARY_YYYY-MM-DD.md (세션 요약 작성/업데이트)
...
1. `docs/Progress/SESSION_START_CHECKLIST.md`
2. `docs/Progress/SESSION_END_CHECKLIST.md`
3. `logs/VERSION_MANAGEMENT.md`
4. `docs/Progress/SESSION_SUMMARY_*.md`
5. `logs/CHANGELOG.md`
6. `logs/VERSION`
...
| **시스템 아키텍처** | `docs/Architecture/SYSTEM_ARCHITECTURE.md` | 3계층 아키텍처 & 데이터 흐름 |
| **문제 해결**       | `docs/Architecture/TROUBLESHOOTING.md`     | 16가지 오류 & 해결법         |
| **자주 하는 작업**  | `docs/Architecture/COMMON_TASKS.md`        | 25가지 작업 단계 가이드      |
