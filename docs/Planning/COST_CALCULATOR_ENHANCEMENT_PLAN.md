...
```mermaid
graph TD
    subgraph "Presentation Layer (Streamlit Pages - UI/UX)"
    ...
    subgraph "Business Logic Layer (Services - 비즈니스 로직)"
    ...
    subgraph "Data Access Layer (Models - 데이터베이스)"
